...
class MyUnitCubeQuad extends CGFobject {
    ...
    initMaterials(scene){
        ...
        this.right.setDiffuse(0.1, 0.1, 0.1, 1);
        ...
        this.front.setDiffuse(0.1, 0.1, 0.1, 1);
        ...
        this.back.setDiffuse(0.1, 0.1, 0.1, 1);
        ...
        this.top.setDiffuse(0.1, 0.1, 0.1, 1);
        ...
        this.bot.setDiffuse(0.1, 0.1, 0.1, 1);
